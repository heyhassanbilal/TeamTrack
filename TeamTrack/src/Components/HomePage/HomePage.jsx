      ...
      <div className="h-screen w-screen overflow-hidden flex">
        ...
        <div className="h-full w-[17.5%] flex flex-col bg-[#EEEEEE] rounded-md">
          ...
          <div className="flex flex-col h-1/6 mt-9">
            <div>
                <h6 className="font-bold text-sm"><i class="fa-solid fa-gear ml-4 mr-4 mb-4"></i>Settings</h6>
            </div>
            <div>
                <h6 className="font-bold text-sm"><i class="fa-solid fa-arrow-right-from-bracket ml-4 mr-4"></i>Sign Out</h6>
            </div>
          </div>
        ...
        <div className="h-full w-[17.5%] bg-slate-500"></div>
      </div>
    </>
  );
}
